      ...
      {step === "phone" ? (
        <>
          <button
            ...
            className="mb-4 flex w-full items-center justify-center gap-2.5 rounded-buttons border border-stone-surface bg-white py-3 text-[15px] font-semibold text-heading-charcoal hover:bg-cream-canvas disabled:opacity-50 transition-all cursor-pointer"
          >
          ...
          <div className="mb-4 flex items-center gap-3">
            <div className="h-px flex-1 bg-stone-surface" />
