...
export function AuthFlow() {
  ...
  return (
    <div className="w-full max-w-md rounded-cards bg-[var(--surface-card)] p-6 shadow-subtle-3 border border-[var(--border-hairline)]">
      <div className="flex flex-col items-center text-center mb-6">
        <span className="flex h-12 w-12 items-center justify-center rounded-full bg-ink-black text-[var(--color-ink-black-text)] mb-3">
      ...
      {uiError && (
        <div className="mb-4 rounded-lg bg-[var(--color-alert-red)]/10 border border-[var(--color-alert-red)]/30 p-3 flex items-start gap-2.5 text-[13px] text-[var(--color-alert-red)]">
      ...
      {uiSuccess && (
        <div className="mb-4 rounded-lg bg-[var(--color-grass-green)]/10 border border-[var(--color-grass-green)]/30 p-3 flex items-start gap-2.5 text-[13px] text-[var(--color-grass-green)]">
      ...
      {step === "phone" ? (
        <>
          <button
            ...
            className="mb-4 flex w-full items-center justify-center gap-2.5 rounded-buttons border border-[var(--border-hairline)] bg-[var(--surface-card)] py-3 text-[15px] font-semibold text-heading-charcoal hover:bg-[var(--surface-canvas)] disabled:opacity-50 transition-all cursor-pointer"
          >
      ...
      {step === "phone" ? (
        <form onSubmit={handlePhoneSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded-buttons bg-ink-black py-3 text-[15px] font-semibold text-[var(--color-ink-black-text)] hover:opacity-90 disabled:opacity-50 transition-all flex items-center justify-center gap-1.5 cursor-pointer"
          >
        ...
        <form onSubmit={handleOtpSubmit} className="space-y-4">
          <div>
            <div className="flex justify-between items-center mb-1.5">
              ...
              <button
                ...
                className="text-[12px] text-muted-gray hover:text-heading-charcoal flex items-center gap-1 font-medium cursor-pointer"
              >
            ...
            <div className="relative">
              ...
              <input
                ...
                disabled={isLoading}
                required
                className="w-full rounded-lg border border-[var(--border-hairline)] bg-[var(--surface-canvas)] pl-10 pr-3 py-3 text-[18px] tracking-[0.2em] font-semibold text-heading-charcoal text-center outline-none focus:border-[var(--color-link-blue)] focus:ring-1 focus:ring-[var(--color-link-blue)] transition-all"
              />
            </div>
          ...
          {timeLeft <= 0 && (
            <button
              ...
              disabled={isLoading}
              className="w-full rounded-buttons border border-[var(--border-hairline)] bg-[var(--surface-canvas)] py-3 text-[14px] font-semibold text-heading-charcoal hover:bg-[var(--surface-card-secondary)] transition-all flex items-center justify-center cursor-pointer"
            >
              Resend OTP Code
            </button>
          )}
